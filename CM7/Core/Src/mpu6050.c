...
HAL_StatusTypeDef MPU6050_INIT(mpu6050_t* mpu6050)
{
	...
	printf("mpu rdy,start init dmp\r\n");

	switch(mpu_dmp_init())
	{

		case 1:
			printf("set sensor fail\r\n");
			return HAL_ERROR;
		case 2:
			printf("config fifo fail\r\n");
			return HAL_ERROR;
		case 3:
			printf("set sample rate fail\r\n");
			return HAL_ERROR;
		case 4:
			printf("load dmp firmware fail\r\n");
			return HAL_ERROR;
		case 5:
			printf("set orientation fail\r\n");
			return HAL_ERROR;
		case 6:
			printf("enable feature fail\r\n");
			return HAL_ERROR;
		case 7:
			printf("set fifo rate fail\r\n");
			return HAL_ERROR;
		case 8:
			printf("self test fail\r\n");
			return HAL_ERROR;
		case 9:
			printf("set dmp state fail\r\n");
			return HAL_ERROR;
		default:
